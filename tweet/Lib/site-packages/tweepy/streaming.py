...
class Stream(object):
    ...
    def firehose(self, count=None, async_=False):
        self.session.params = {'delimited': 'length'}
        if self.running:
            raise TweepError('Stream object already connected!')
    ...
    def sample(self, async_=False, languages=None):
        self.session.params = {'delimited': 'length'}
        if self.running:
            raise TweepError('Stream object already connected!')
    ...
    def filter(self, follow=None, track=None, async_=False, locations=None,
    ...
    def sitestream(self, follow, stall_warnings=False,
                   with_='user', replies=False, async_=False):
        self.body = {}
        if self.running:
            raise TweepError('Stream object already connected!')
